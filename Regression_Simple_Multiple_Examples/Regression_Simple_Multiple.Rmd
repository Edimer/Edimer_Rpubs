...
- Para la construcción del modelo de *RLM* se comprueba la multicolinealidad de las variables y se proponen cuatro alternativas:
    - <tred>**Modelo 0:**</tred> modelo con todas las variables incluidas como predictoras.
    ...
    - <tred>**Modelo 2:**</tred> Modelo de *RLM* con eliminación de variables por *VIF* a través del métodos *Stepwise* (utilizado por los autores del artículo).
...
- Selección de predictores teniendo en cuenta valores iguales o inferiores a 0.70 de correlación. La selección es posible hacerla con la bibliteca [`usdm`](https://cran.r-project.org/web/packages/usdm/usdm.pdf) que posee funciones flexibles para diagnósticos de multicolinealidad.
